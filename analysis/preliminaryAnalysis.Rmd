---
title: "PRCP Preliminary Analysis"
...
# Post-replication citation patterns in psychological science: Preliminary analysis
...
rbind(
  ...
  mutate(replicationCitations_percent = round((replicationCitations/targetCitations)*100,0)) %>%
...
rbind(
  ...
  mutate(counterargs_percent = round(
    (counterargs_yes/(counterargs_yes+counterargs_no))*100,
    0)) %>%
  kable(caption = 'Use of counter arguments when replication study cited') %>%
  kable_styling(full_width = F)
```
